...
RUN apt-get update && apt-get -y install gcc-5 g++-5 gcc-7 g++-7 ; update-alternatives --remove-all gcc ; update-alternatives --install /usr/bin/gcc gcc /usr/bin/gcc-5 50 --slave /usr/bin/g++ g++ /usr/bin/g++-5 ; update-alternatives --install /usr/bin/gcc gcc /usr/bin/gcc-6 80 --slave /usr/bin/g++ g++ /usr/bin/g++-6 ; update-alternatives --install /usr/bin/gcc gcc /usr/bin/gcc-7 70 --slave /usr/bin/g++ g++ /usr/bin/g++-7 ; update-alternatives --set gcc "/usr/bin/gcc-7"
